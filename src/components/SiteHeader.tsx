...
export function SiteHeader({ variant = 'overlay' }: { variant?: 'overlay' | 'solid' }) {
  ...
  type NavChild = { label: string; hash: string; page?: string };
  type NavItem = {
    label: string;
    hash: string;
    page?: string;
  ...
  const navItems: NavItem[] = [
    {
      ...
      hash: '#fahrzeuge',
      children: [
        { label: 'Fahrzeugbörse', hash: '#fahrzeuge', page: '/fahrzeuge' },
        { label: 'Vermittlung', hash: '#fahrzeuge', page: '/vermittlung' },
        { label: 'Ankauf', hash: '#ankauf', page: '/ankauf' },
      ],
    },
    {
      ...
      page: '/konfigurator',
      children: [
        { label: t('nav.chiptuning'), hash: '#chiptuning', page: '/konfigurator' },
        { label: t('nav.dyno'), hash: '#pruefstand', page: '/pruefstand-buchung' },
      ],
    },
    { label: t('nav.wheels'), hash: '#raeder', page: '/raeder-konfigurator' },
    { label: 'Finanzierung', hash: '#finanzierung', page: '/finanzierung' },
    { label: t('nav.contact'), hash: '#kontakt' },
  ];
